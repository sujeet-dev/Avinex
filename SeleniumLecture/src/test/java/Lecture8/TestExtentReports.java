...
//		test=extent.createTest("Validate Title");
    ...
    public void UpdateResult(ITestResult result) {
		...
		if (result.getStatus()==ITestResult.FAILURE) {
			 ...
			 Markup m= MarkupHelper.createLabel("Test Case Failed : " +testcaseName, ExtentColor.RED);
//			test.fail("fail the test case : " + testcaseName);
			test.fail(m);
			
		}else if (result.getStatus()==ITestResult.SUCCESS) {
			 Markup m= MarkupHelper.createLabel("Test Case Pass : " +testcaseName, ExtentColor.GREEN);
//			test.pass("Pass the test case : " + testcaseName);
			 test.pass(m);
			 
		}else if (result.getStatus()==ITestResult.SKIP) {
			 Markup m= MarkupHelper.createLabel("Test case Skip : " +testcaseName, ExtentColor.AMBER);
